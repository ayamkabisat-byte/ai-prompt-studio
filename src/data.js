...
export const POSES = [
  ...
  { group: '💑 Couple — Romantis', items: [
    ...
    { id: 'Couple in a tender back hug, one person from behind wrapping arms around the other, both smiling or eyes closed', label: 'Back Hug (Pelukan dari Belakang), Keduanya Tersenyum/Menutup Mata', allowedTypes: ['all'] },
  ...
  { group: '💑 Couple — Pernikahan & Formal', items: [
    { id: 'Classic wedding couple pose: groom standing behind bride, both hands on her shoulders, both smiling softly at the camera', label: 'Pernikahan Klasik: Pengantin Pria di Belakang, Tangan di Bahu Pengantin Wanita', allowedTypes: ['all'] },
  ...
  { group: '👨‍👩‍👧‍👦 Group — Keluarga', items: [
    ...
    { id: 'Parents and children cooking or baking together in a kitchen, all wearing aprons, joyful family moment', label: 'Masak/Baking Bersama di Dapur, Semua Pakai Apron (Family Kitchen)', allowedTypes: ['indoor'] },
  ]},
  { group: '👥 Group — Teman & Tim', items: [
    ...
    { id: 'Group of friends sitting together on stairs, ledge, or bench, relaxed and candid, varied natural poses', label: 'Teman Duduk Bersama di Tangga/Bangku, Pose Bervariasi (Candid)', allowedTypes: ['urban', 'indoor', 'nature'] },
    ...
    { id: 'Group of friends in a long line, each holding the shoulders of the person in front in a chain/train pose, all laughing', label: 'Pose Kereta: Berurutan Pegang Bahu dari Belakang, Semua Tertawa', allowedTypes: ['all'] },
    ...
    { id: 'Group standing in a tight huddle, arms all thrown into the center stacked on top of each other, team spirit', label: 'Tangan Semua ke Tengah Ditumpuk (Team Huddle Spirit)', allowedTypes: ['all'] },
  ]},
  { group: '🎉 Group — Perayaan & Momen Spesial', items: [
    ...
    { id: 'Group of graduates in robes and mortarboard hats throwing hats in the air together, joyful and celebratory', label: 'Wisudawan Lempar Toga Bersama (Graduation Celebration)', allowedTypes: ['all'] },
    ...
    { id: 'Group of friends at a birthday party, surrounding the birthday cake, all about to blow candles together', label: 'Ulang Tahun: Melingkari Kue, Semua Siap Tiup Lilin Bersama', allowedTypes: ['indoor', 'cafe', 'restaurant'] },
    { id: 'Colleagues in a corporate group photo, arranged neatly with management in center front row, arranged by seniority', label: 'Foto Korporat/Kantor: Susunan Formal, Atasan di Tengah Depan', allowedTypes: ['studio', 'indoor', 'office', 'all'] },
  ]},
];
...
    { id: 'Reading glasses', label: 'Kacamata Baca', gender: ['male', 'female', 'unisex'] },
    { id: 'Thin round frame glasses', label: 'Kacamata Bingkai Bulat Tipis', gender: ['male', 'female', 'unisex'] },
    { id: 'Sunglasses', label: 'Kacamata Hitam', gender: ['male', 'female', 'unisex'] },
    { id: 'Oversized sunglasses', label: 'Kacamata Hitam Oversized', gender: ['female', 'unisex'] },
    { id: 'White frame sunglasses', label: 'Kacamata Bingkai Putih', gender: ['female', 'unisex'] },
    { id: 'Blue sunglasses resting on head', label: 'Kacamata Biru di Atas Kepala', gender: ['male', 'female', 'unisex'] },
    { id: 'Trendy square frame glasses', label: 'Kacamata Frame Kotak (Trendy)', gender: ['male', 'female', 'unisex'] },
  ]},
  { group: 'Topi & Kepala', items: [
    { id: 'Pink and yellow flower hair clip', label: 'Jepit Rambut Bunga (Pink/Kuning)', gender: ['female'] },
    { id: 'Cream and white hair scrunchie', label: 'Scrunchie Rambut Krem/Putih', gender: ['female'] },
    { id: 'Green plain beanie hat', label: 'Beanie/Kupluk Hijau', gender: ['male', 'female', 'unisex'] },
    { id: 'Black-and-white knit beanie hat', label: 'Beanie/Kupluk Rajut Hitam-Putih', gender: ['male', 'female', 'unisex'] },
    { id: 'White baseball cap', label: 'Topi Bisbol Putih', gender: ['male', 'female', 'unisex'] },
    { id: 'Green baseball cap', label: 'Topi Bisbol Hijau', gender: ['male', 'female', 'unisex'] },
    { id: 'Black baseball cap worn backwards', label: 'Topi Bisbol Hitam (Dibalik ke Belakang)', gender: ['male', 'unisex'] },
    { id: 'Khaki bucket hat with a neck strap', label: 'Topi Bucket Khaki (dengan Tali)', gender: ['male', 'female', 'unisex'] },
    { id: 'Tupac style tied bandana on head', label: 'Bandana Ikat (Tupac Style)', gender: ['male', 'unisex'] },
    { id: 'Silky durag tied on head', label: 'Durag Penutup Kepala (Rapper Style)', gender: ['male', 'unisex'] },
    { id: 'Black wireless headphones worn over the ears or around the neck', label: 'Headphone Nirkabel Hitam', gender: ['male', 'female', 'unisex'] },
    { id: 'Classic beret hat, worn slightly tilted', label: 'Baret (Beret Hat, Miring Stylish)', gender: ['female', 'unisex'] },
    { id: 'Wide brim straw hat', label: 'Topi Jerami Lebar (Pantai/Resort)', gender: ['female'] },
    { id: 'Headband', label: 'Headband / Bando', gender: ['female'] },
  ]},
  { group: 'Perhiasan & Tindik', items: [
    { id: 'Nose piercing', label: 'Tindik Hidung', gender: ['male', 'female', 'unisex'] },
    { id: 'Septum piercing', label: 'Tindik Septum', gender: ['male', 'female', 'unisex'] },
    { id: 'Eyebrow piercing', label: 'Tindik Alis', gender: ['male', 'female', 'unisex'] },
    { id: 'Lip piercing', label: 'Tindik Bibir', gender: ['male', 'female', 'unisex'] },
    { id: 'Single ear piercing (stud)', label: 'Tindik Satu Telinga (Stud)', gender: ['male', 'female', 'unisex'] },
    { id: 'Double ear piercings', label: 'Tindik Dua Telinga', gender: ['female', 'unisex'] },
    { id: 'Large punk style hoop earrings', label: 'Anting Ring Besar (Punk/Edgy)', gender: ['male', 'female', 'unisex'] },
    { id: 'Gold chain necklace', label: 'Kalung Emas (Chain)', gender: ['male', 'female', 'unisex'] },
    { id: 'Silver necklace', label: 'Kalung Perak', gender: ['male', 'female', 'unisex'] },
    { id: 'Chunky hip-hop chain with a massive iced-out diamond pendant', label: 'Kalung Rantai Besar + Permata (Rapper)', gender: ['male', 'unisex'] },
    { id: 'Diamond iced-out teeth grillz', label: 'Grillz Gigi (Iced Out/Diamond)', gender: ['male', 'unisex'] },
    { id: 'Leather bracelet', label: 'Gelang Kulit', gender: ['male', 'unisex'] },
    { id: 'Chrome Hearts silver rings on fingers', label: 'Cincin Chrome Hearts', gender: ['male', 'female', 'unisex'] },
    { id: 'Diamond engagement ring', label: 'Cincin Berlian', gender: ['female'] },
    { id: 'Gold signet ring', label: 'Cincin Emas (Signet)', gender: ['male'] },
    { id: 'Elegant pearl necklace', label: 'Kalung Mutiara Elegan', gender: ['female'] },
    { id: 'Pearl stud earrings', label: 'Anting Mutiara', gender: ['female'] },
    { id: 'Vintage pearl brooch pinned on chest', label: 'Bros Mutiara (Vintage Brooch)', gender: ['female'] },
    { id: 'Delicate gold layered necklaces (2-3 chains)', label: 'Kalung Emas Berlapis (2-3 Rantai Tipis)', gender: ['female', 'unisex'] },
    { id: 'Shell or pearl anklet bracelet on wrist', label: 'Gelang Tangan Kerang/Mutiara (Beach Vibe)', gender: ['female'] },
    { id: 'Pearl drop earrings', label: 'Anting Mutiara Drop', gender: ['female'] },
    { id: 'Silk scrunchie on wrist', label: 'Scrunchie Sutra di Pergelangan', gender: ['female'] },
    { id: 'Thin gold bangle bracelet', label: 'Gelang Bangle Emas Tipis', gender: ['female', 'unisex'] },
    { id: 'Charm bracelet', label: 'Gelang Charm', gender: ['female'] },
    { id: 'Statement cocktail ring', label: 'Cincin Besar (Cocktail Ring)', gender: ['female'] },
    { id: 'Anklet bracelet', label: 'Gelang Kaki (Anklet)', gender: ['female'] },
    { id: 'Hair pins decorative', label: 'Pin Rambut Dekoratif', gender: ['female'] },
  ]},
  { group: 'Dasi, Syal & Sabuk', items: [
    { id: 'Knit tie', label: 'Dasi Rajut (Knit Tie)', gender: ['male', 'unisex'] },
    { id: 'Striped necktie', label: 'Dasi Motif Garis', gender: ['male', 'unisex'] },
    { id: 'Red necktie', label: 'Dasi Merah', gender: ['male', 'unisex'] },
    { id: 'Blue necktie', label: 'Dasi Biru', gender: ['male', 'unisex'] },
    { id: 'Formal necktie', label: 'Dasi Formal', gender: ['male','unisex'] },
    { id: 'Bow tie', label: 'Dasi Kupu-kupu (Bow Tie)', gender: ['male','unisex'] },
    { id: 'Elegant silk neckerchief or ascot tie', label: 'Syal Sutra / Ascot (Elegan)', gender: ['male', 'female', 'unisex'] },
    { id: 'Thick wool winter scarf', label: 'Syal Wol Musim Dingin', gender: ['male', 'female', 'unisex'] },
    { id: 'Light chiffon scarf loosely draped around the neck', label: 'Selendang Sifon Ringan di Leher', gender: ['female'] },
    { id: 'High white calf-length socks', label: 'Kaos Kaki Putih Sebetis', gender: ['male', 'female', 'unisex'] },
    { id: 'White knee-high socks', label: 'Kaos Kaki Putih Selutut', gender: ['female'] },
    { id: 'Patterned socks with fun motifs', label: 'Kaos Kaki Bermotif (Fun Socks)', gender: ['male', 'female', 'unisex'] },
    { id: 'Pocket square in suit jacket', label: 'Pocket Square di Jas', gender: ['male'] },
    { id: 'Suspenders / braces', label: 'Suspender / Braces', gender: ['male','unisex'] },
    { id: 'Lapel pin', label: 'Pin Lapel Jas', gender: ['male','unisex'] },
    { id: 'Leather belt with metal buckle', label: 'Ikat Pinggang Kulit (Metal Buckle)', gender: ['male','unisex'] },
    { id: 'Tactical military belt', label: 'Ikat Pinggang Tactical/Militer', gender: ['male'] },
  ]},
  { group: 'Tas & Kantong', items: [
    { id: 'Woven rattan or straw tote bag', label: 'Tote Bag Anyaman Rotan/Jerami', gender: ['female', 'unisex'] },
    { id: 'Pink canvas tote bag', label: 'Tote Bag Kanvas Pink', gender: ['female'] },
    { id: 'Cream backpack', label: 'Tas Ransel Krem', gender: ['male', 'female', 'unisex'] },
    { id: 'Black leather shoulder bag', label: 'Shoulder Bag Kulit Hitam', gender: ['female', 'unisex'] },
    { id: 'White crossbody sling bag', label: 'Tas Selempang Putih (Crossbody)', gender: ['female', 'unisex'] },
    { id: 'Sports duffel bag', label: 'Tas Duffel Olahraga', gender: ['male', 'female', 'unisex'] },
    { id: 'Classic leather briefcase', label: 'Tas Kerja (Briefcase Kulit Klasik)', gender: ['male', 'unisex'] },
    { id: 'Trendy mini shoulder bag', label: 'Mini Shoulder Bag (Trendy)', gender: ['female'] },
    { id: 'Aesthetic paper bag from a boutique store', label: 'Paper Bag Estetik (Boutique)', gender: ['male', 'female', 'unisex'] },
    { id: 'Alfamart plastic shopping bag', label: 'Kantong Kresek Alfamart', gender: ['male', 'female', 'unisex'] },
    { id: 'Indomaret plastic shopping bag', label: 'Kantong Kresek Indomaret', gender: ['male', 'female', 'unisex'] },
    { id: 'FamilyMart plastic shopping bag', label: 'Kantong Kresek FamilyMart', gender: ['male', 'female', 'unisex'] },
  ]},
  { group: 'Properti Kafe & Kuliner', items: [
    { id: 'Ceramic coffee mug with latte art', label: 'Mug Keramik Kopi (Latte Art)', gender: ['male', 'female', 'unisex'] },
    { id: 'Iced coffee in a transparent glass with a straw', label: 'Es Kopi di Gelas Transparan (Sedotan)', gender: ['male', 'female', 'unisex'] },
    { id: 'Elegant espresso cup (demitasse)', label: 'Cangkir Espresso Elegan (Demitasse)', gender: ['male', 'female', 'unisex'] },
    { id: 'Pastel-colored macaroon or dessert plate', label: 'Piring Dessert Warna Pastel (Macaron)', gender: ['male', 'female', 'unisex'] },
    { id: 'Open journal/notebook and pen on a cafe table', label: 'Buku Jurnal Terbuka + Pena (di Meja Kafe)', gender: ['male', 'female', 'unisex'] },
    { id: 'Small potted succulent plant on a cafe table', label: 'Tanaman Succulent Kecil di Meja Kafe', gender: ['male', 'female', 'unisex'] },
    { id: 'Croissant or pastry on a plate', label: 'Croissant / Pastri di Atas Piring', gender: ['male', 'female', 'unisex'] },
  ]},
  { group: 'Lainnya (Properti)', items: [
    { id: 'Black leather driving gloves', label: 'Sarung Tangan Kulit Hitam', gender: ['male', 'unisex'] },
    { id: 'Red electric guitar', label: 'Gitar Elektrik Merah', gender: ['male', 'female', 'unisex'] },
    { id: 'Acoustic guitar', label: 'Gitar Akustik', gender: ['male', 'female', 'unisex'] },
    { id: 'Action camera (GoPro)', label: 'Kamera Aksi (GoPro)', gender: ['male', 'female', 'unisex'] },
    { id: 'Vintage film camera held in hand', label: 'Kamera Film Vintage di Tangan', gender: ['male', 'female', 'unisex'] },
    { id: 'Festival wristbands', label: 'Gelang Festival', gender: ['male', 'female', 'unisex'] },
    { id: 'Flowers bouquet held in hand', label: 'Buket Bunga di Tangan', gender: ['female', 'unisex'] },
    { id: 'Classic paperback book held in hand', label: 'Novel/Buku Tipis di Tangan', gender: ['male', 'female', 'unisex'] },
    { id: 'Leather wallet visibly in hand', label: 'Dompet Kulit di Tangan', gender: ['male','unisex'] },
    { id: 'Cigar in hand', label: 'Cerutu di Tangan (Cigar)', gender: ['male'] },
  ]},
];
...
  { id: 'Natural look, no visible makeup', label: 'Bawaan Asli (No Makeup/Natural)', gender: ['male','female','unisex'] },
  { id: 'Minimalist clean girl makeup', label: 'Minimalist Makeup', gender: ['female'] },
  { id: 'Korean idol makeup, glass skin, gradient lips', label: 'Korean Idol Makeup (Female)', gender: ['female'] },
  { id: 'K-pop boyband makeup, subtle eyeliner, flawless skin, tinted lip balm', label: 'K-Pop Boyband Makeup (Male)', gender: ['male'] },
  { id: 'Chinese Douyin style makeup, glittery eyes, bold lips', label: 'Chinese Douyin Makeup', gender: ['female'] },
  { id: 'Indonesian traditional glamorous makeup', label: 'Indonesian Makeup', gender: ['female'] },
  { id: 'Filipina Bebot style makeup', label: 'Bebot Makeup', gender: ['female'] },
  { id: 'Latina makeup, sharp contour, thick lashes', label: 'Latina Makeup', gender: ['female'] },
  { id: 'Arabic/Farsi makeup, heavy dark eyeliner, dramatic eyes', label: 'Arabic/Farsi Makeup', gender: ['female', 'unisex'] },
  { id: 'Dark Emo makeup, heavy black eyeliner and dark lips', label: 'Emo / Goth Makeup', gender: ['male', 'female', 'unisex'] },
  { id: 'Glam metal rock band makeup, dramatic theatrical', label: 'Glam Rock / Band Makeup', gender: ['male', 'female', 'unisex'] },
  { id: 'Visual Kei / Harajuku makeup, extreme styling, dramatic contour', label: 'Visual Kei / Harajuku Makeup', gender: ['male', 'female', 'unisex'] },
  { id: 'SFX Makeup: Realistic facial scars and stitches', label: 'Efek Wajah (Bekas Luka/Jahitan)', gender: ['male', 'female', 'unisex'] },
];
